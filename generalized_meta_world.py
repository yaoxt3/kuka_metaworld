...
from learning_to_be_taught.environments.meta_world.meta_world_benchmarks import ML10, ML1, MLR, SingleEnv, ML45, MLR
...
class GeneralizedMetaWorld(gym.Env):
    ...
    #    self.endeff_pos = metaworld.envs.mujoco.sawyer_xyz.sawyer_xyz_env.SawyerMocapBase.get_endeff_pos(self.env)
...
if __name__ == '__main__':
    ...
    env = GeneralizedMetaWorld(benchmark='ml10', action_repeat=1, demonstration_action_repeat=1,
                               max_trials_per_episode=1, sample_num_classes=1, mode='meta_training', v2=False)
